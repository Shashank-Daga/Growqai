      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <div className="space-y-2">
              <Link href="/terms-of-service" className="block text-[#40444b] hover:text-[#004250] text-sm transition-colors">
                Terms of Service
              </Link>
              <Link href="/privacy-policy" className="block text-[#40444b] hover:text-[#004250] text-sm transition-colors">
                Privacy Policy
              </Link>
            </div>
          </div>
