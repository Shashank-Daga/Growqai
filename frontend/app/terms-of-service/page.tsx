  ...
  return (
    <section className="min-h-screen bg-white px-8 md:px-16 lg:px-24 py-16">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Breadcrumb */}
        <div className="text-sm text-gray-500 mb-10">/TERMS OF SERVICE</div>
        ...
        <div className="max-w-4xl space-y-8 text-gray-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">1. About Growqai</h2>
            <p>
              Growqai is a growth consulting firm that helps businesses scale intelligently by focusing on three critical pillars: Capital, Client, and Talent, powered by the strategic use of Artificial Intelligence. Our platform, resources, and services are designed to enable organizations to make data-backed decisions that accelerate their growth trajectory.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              Growqai offers a range of consulting, strategic advisory, and AI-powered growth enablement services. We may modify, suspend, or discontinue certain features or services at any time without notice. We are not liable for any modification or discontinuation.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">4. Use of Website and Services</h2>
            <p className="mb-4">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">5. User Accounts (if applicable)</h2>
            <p className="mb-4">
          ...
          <div>
            ...
            <p>
              Any confidential or proprietary information shared between you and Growqai in the course of business shall remain confidential. You agree not to disclose, copy, or use such information for any purpose other than as permitted under a written agreement or engagement contract.
            </p>
          </div>

          <div>
            <h2 className="text-2xl font-semibold text-gray-900 mb-4">8. Third-Party Links and Tools</h2>
            <p>
              Our website may include links to third-party websites or tools for your convenience. Growqai does not control, endorse, or assume responsibility for these third-party sites, their content, or their privacy practices. Accessing such sites is at your own risk.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              These Terms shall be governed by and construed in accordance with the laws of India. Any disputes arising under or in connection with these Terms shall be subject to the exclusive jurisdiction of the courts in Pune, Maharashtra, India.
            </p>
          </div>
          ...
          <div>
            ...
            <p>
              We may revise or update these Terms from time to time. Any changes will be posted on this page with a revised "Effective Date." Your continued use of our website after changes have been made constitutes acceptance of the new Terms.
            </p>
          </div>
